...
import { Activity, Mail, Lock, Loader2, Sparkles, CheckCircle2, Shield, ArrowRight } from "lucide-react";
      ...
      <div className="hidden lg:flex lg:col-span-7 bg-slate-900/20 border-r border-slate-900/60 p-12 flex-col justify-between relative overflow-hidden grid-mesh">
        ...
        <div className="my-auto max-w-lg space-y-8">
          <span className="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full text-xs font-semibold bg-indigo-500/10 text-indigo-300 border border-indigo-500/20">
            <Sparkles className="h-3 w-3 animate-pulse text-indigo-400" /> Clinical Summaries & RAG Assistant
          </span>
          <h2 className="text-4xl md:text-5xl font-extrabold tracking-tight leading-tight text-white">
            Unlock Instant Clinical Insights from Any Report
          </h2>
          <p className="text-slate-400 leading-relaxed text-sm md:text-base">
            Securely access parsed records, verify diagnostic metrics, and ask contextually isolated questions through a dedicated Qdrant-powered RAG pipeline.
          </p>
          ...
          <div className="space-y-4 pt-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-xs font-bold text-slate-200">HIPAA Compliant Integrity</p>
                <p className="text-xs text-slate-500 mt-0.5">Vector chunks isolates queries contextually to each user.</p>
              </div>
            </div>
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none text-slate-555">
